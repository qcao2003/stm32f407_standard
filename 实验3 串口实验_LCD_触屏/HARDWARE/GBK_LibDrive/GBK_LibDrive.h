...
#define	FDI_SET       GPIO_SetBits(GPIOF,GPIO_Pin_11)      //数据输出 PF11
#define	FDI_CLR       GPIO_ResetBits(GPIOF,GPIO_Pin_11)    //数据输出 PF11

#define	FDO_IN        GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_2)   //数据输入 PB2


#define	FCLK_SET      GPIO_SetBits(GPIOB,GPIO_Pin_0)   //数据时钟线  PB0
#define	FCLK_CLR      GPIO_ResetBits(GPIOB,GPIO_Pin_0) //数据时钟线  PB0
